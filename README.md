...
## Repository layout
- Arduino sketch: [esp32c6-topt-lcd.ino](esp32c6-topt-lcd.ino)
...
Edit the user config section in [config.h](config.h):
...
### 3) Build and upload
1. Open [esp32c6-topt-lcd.ino](esp32c6-topt-lcd.ino) in Arduino IDE.
